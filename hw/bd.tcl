...
0} {CH2 0} {CH3 0} {CH4 0} {CH5 0} {CH6 0} {CH7 0} {CH8 1} {CH9 1}}\
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_0_M_AXIS_MM2S] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins axis_ila_0/SLOT_1_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_0_M_AXI_MM2S] [get_bd_intf_pins axi_dma_0/M_AXI_MM2S] [get_bd_intf_pins axis_ila_0/SLOT_4_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_0_M_AXI_S2MM] [get_bd_intf_pins axi_dma_0/M_AXI_S2MM] [get_bd_intf_pins axis_ila_0/SLOT_3_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_0_M_AXI_SG] [get_bd_intf_pins axi_dma_0/M_AXI_SG] [get_bd_intf_pins axis_ila_0/SLOT_2_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_0_smc_M00_AXI] [get_bd_intf_pins axi_dma_0_smc/M00_AXI] [get_bd_intf_pins axis_ila_0/SLOT_0_AXI]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axi_dma_0_smc_M00_AXI]
  ...
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins axis_ila_1/probe0] [get_bd_pins versal_cips_0/pl_ps_irq8]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets axi_dma_0_mm2s_introut]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins axis_ila_1/probe1] [get_bd_pins versal_cips_0/pl_ps_irq9]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets axi_dma_0_s2mm_introut]
  connect_bd_net -net rst_versal_cips_0_333M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_dma_0_smc/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_ila_0/resetn] [get_bd_pins rst_versal_cips_0_333M/peripheral_aresetn]
  ...
  connect_bd_net -net versal_cips_0_pl0_ref_clk [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_0_smc/aclk] [get_bd_pins axi_noc_0/aclk6] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_ila_0/clk] [get_bd_pins axis_ila_1/clk] [get_bd_pins rst_versal_cips_0_333M/slowest_sync_clk] [get_bd_pins versal_cips_0/pl0_ref_clk]
